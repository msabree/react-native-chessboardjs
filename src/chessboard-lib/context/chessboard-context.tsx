...
import {
  ...
  export const ChessboardProvider = forwardRef(
    (
      ...
      const previousTimeoutRef = useRef<NodeJS.Timeout>(null);
      ...
      useEffect(() => {
        ...
        if (isWaitingForAnimation) {
          ...
          if (wasManualDrop) {
            ...
            (previousTimeoutRef as React.MutableRefObject<NodeJS.Timeout | null>).current = newTimeout;
          }
        }
        ...
        return () => {
          clearTimeout(previousTimeoutRef.current as any);
        };
      }, [position]);
  ...
  ChessboardProvider.displayName = "ChessboardProvider";
